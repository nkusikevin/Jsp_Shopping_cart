                            ...
                            <div class="men-pro-item simpleCart_shelfItem">
                                ...
                                <div class="item-info-product ">
                                    ...
                                    <div class="info-product-price">
                                        ...
                                        <input type="hidden" name="mrp_price" value="<%=retriveProduct.getString("mrp_price")%>"> <span class="item_price"><%=retriveProduct.getString("price")%> Rwf</span>
                                        <del><%=retriveProduct.getString("mrp_price")%>Rwf</del>
                                    </div>
