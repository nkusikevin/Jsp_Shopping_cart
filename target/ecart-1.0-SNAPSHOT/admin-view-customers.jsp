                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td><a
                                                        ...
                                                        href="admin-delete-customer.jsp?id=<%=resultSet.getInt("id")%>"
                                                        class="btn btn-danger" onclick="return confirm('Are you sure Do you want to delete this customer?');">Delete</a></td>
                                            </tr>
                                        </tbody>
                                        <%
                                            }
